-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'SCHOOL_ADMIN', 'TEACHER', 'PARENT', 'STUDENT');
...
-- CreateIndex
CREATE UNIQUE INDEX "classes_schoolId_className_gradeLevel_academicYear_key" ON "classes"("schoolId", "className", "gradeLevel", "academicYear");
